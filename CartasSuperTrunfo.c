...
int main(){
    ...
    // variaveis de comparação 1 ou 0
    int resultadoPop;
    int resultadoArea;
    int resultadoPib;
    int resultadoPontos;
    ...
    resultadoPop = populacao1 > populacao2 ? 1 : 0;
    resultadoArea = area1 > area2 ? 1 : 0;
    resultadoPib = pib1 > pib2 ? 1 : 0;
    resultadoPontos = pontos1 > pontos2 ? 1 : 0;
    resultadoDensidade = densidade1 < densidade2 ? 1 : 0;
    resultadoPibPC = pibPC1 > pibPC2 ? 1 : 0;
    ...
    printf("Populacao: Carta 1 venceu a Carta 2? %d\n", resultadoPop);
    ...
    printf("Densidade: Carta 1 venceu a Carta 2? %d\n", resultadoDensidade);
